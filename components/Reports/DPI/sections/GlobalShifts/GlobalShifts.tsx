...
import styles from './GlobalShifts.module.scss';

const GlobalShifts = () => {
  return (
    <section className={styles["global_wrapper"]} id="global">
      <div className={styles["section_container"]}>
        <div className={styles["label"]}>Global Digital Public Infrastructure Outlook</div>
